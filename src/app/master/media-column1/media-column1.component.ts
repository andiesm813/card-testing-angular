...
@Component({
  selector: 'app-media-column1',
  standalone: true,
  imports: [IGX_CARD_DIRECTIVES, IgxAvatarComponent, IgxIconComponent],
  templateUrl: './media-column1.component.html',
  styleUrls: ['./media-column1.component.scss']
})
export class MediaColumn1Component implements OnInit, OnDestroy {
